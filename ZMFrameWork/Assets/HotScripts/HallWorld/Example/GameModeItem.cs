...
public class GameModeItem : MonoBehaviour
{
    ...
    public async void EnterGame()
    {
        ...
        {
            GameWorldHotFixBridge.OnLoadHotFixWorld(WorldEnum.SKWorld,"ZMGC.SK","Assets/GameData/ShuangKou/HotFixDll/ZM.SKWorld.dll.bytes");
        }
        else if (gameType == BundleModuleEnum.WuZhang)
        {
            GameWorldHotFixBridge.OnLoadHotFixWorld(WorldEnum.WZWorld,"ZMGC.WZ","Assets/GameData/WuZhang/HotFixDll/ZM.WZWorld.dll.bytes");
        }
    }
